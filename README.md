...
- relations entre entités (User, Offer, Application, Internship, Evaluation)  
- workflow logique : **candidature → acceptation → stage → évaluation**  
...
## ✅ Conclusion
Ce projet propose une implémentation complète d’un système de gestion de stages, avec une architecture moderne full‑stack et un workflow métier complet.
